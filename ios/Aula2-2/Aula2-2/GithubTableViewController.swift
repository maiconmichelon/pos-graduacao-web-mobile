...
class GithubTableViewController: UITableViewController, UISearchBarDelegate {
    ...
    func atualizar(urlConsulta: String) {
        print(urlConsulta)
        let url = NSURL(string: "https://api.github.com/search/repositories?q=\(urlConsulta)")
